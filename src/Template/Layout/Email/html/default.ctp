	...
	<tr>
		<td>
			<center>
				...
				echo $this->Email->table(null, [
					'style' => ['background-color:none', 'border-radius:6px'],
					'width' => 600
				]);
				...
				<tr>
					<td align="center" valign="top">
						<?= $this->Email->table(null, ['width' => 600]) ?>
						<tbody>
							<tr>
								<td>
						...
						<?= $this->Email->table(null, false) ?>
					</td>
				</tr>

				<tr>
					<td align="center" valign="top">
						<?= $this->Email->table(null, ['width' => 600, 'style' => ['background-color:#fff;', 'border-radius:6px;']]); ?>
						<tbody>
							<tr>
